        ...
        for( j = 0; j < n; j++ ) {
            ...
            for( k = 0; k < m/8*8; k += 8 ) {
                ...
                for( i = 0; i < n/8*8; i += 8) {
                    ...
                    first1 = _mm_loadu_ps(a+n);
                    first2 = _mm_loadu_ps(a+2*n);
                    first3 = _mm_loadu_ps(a+3*n);
                    first4 = _mm_loadu_ps(a+4*n);
                    first5 = _mm_loadu_ps(a+5*n);
                    first6 = _mm_loadu_ps(a+6*n);
                    first7 = _mm_loadu_ps(a+7*n);
                    c = C+i+j*n;
